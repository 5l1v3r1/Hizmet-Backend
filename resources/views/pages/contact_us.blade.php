...
@section('content')
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            ...
            <div class="col-lg-6" style="margin-bottom: 30px;">
                <h1 style="margin-top: 0px; text-align: center;">Ekopak Mimarlık Mühendislik Yazılım Hiz. Ltd. Şti</h1>
                ...
                <div class="col-xs-10 col-xs-offset-1" style="margin-bottom: 30px;">
                    ...
                    <address>
                        <i class="fa fa-envelope-o fa-lg" aria-hidden="true"></i> info@ekopak.co
                    </address>
                    ...
                    <a href="https://tr.linkedin.com/" style="margin-left: 10px;">
...
@section('page_level_js')
    ...
    <script>
        ...
        function initMap() {
            var myLatLng = {lat: 41.0194407, lng: 28.6467988};
